 <?php $item_count = $item_count->scalar;  $sku_exist = $sku_exist->scalar; if($item_count > 0 && $sku_exist == false){ ?>
                             <div class="alert alert-primary mt-3" role="alert">
                                        You have <span class="badge badge-pill badge-secondary go-to-cart-btn"><?php echo $item_count; ?></span> in your cart. <a href="<?php echo get_site_url().'/'.CART; ?>">Go to Cart</a>
                                    </div>
                            <?php } elseif($item_count > 0 && $sku_exist != false){ ?>
                                    <div class="alert alert-primary mt-3" role="alert">
                                        ...
                                        <div class="text-center">
                                            <a href="<?php echo get_site_url().'/'.CART; ?>" class="btn btn-light text-center go-to-cart-btn">Go to Cart</a>
                                        </div>
                                    </div>
                            <?php } ?>