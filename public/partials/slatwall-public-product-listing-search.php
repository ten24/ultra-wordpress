<div class="jumbotron jumbotron-fluid full-width-section-slatwall">
            <div class="container text-center">
                <h1 class="display-4">Global Product Search</h1>
                <p class="lead">Your search for "<?php echo $search_val; ?>" returned <?php echo $products->recordsCount ?> available <?php echo $products->recordsCount<=1?'product':'products'; ?></p>
            </div>
        </div>
<div class="container">
